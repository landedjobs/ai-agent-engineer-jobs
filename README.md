...
> An open, **auto-updated** list of AI Agent Engineer roles. Updated 2026-06-30 · **0 live roles**.
> Curated by [Landed](https://landed.jobs) — scout, get **referred**, prep, and land AI-native jobs.

⭐ **Star this repo** to track new AI Agent Engineer roles — it refreshes regularly.

---

## What is a AI Agent Engineer? (60-second version)
...
## Live AI Agent Engineer roles

| Company | Role | Location | Type | Posted |
|---|---|---|---|---|
| _List updating — check back soon_ |  |  |  |  |

> A sample of what's live. **[See every AI Agent Engineer role + 1-click tracking on Landed →](https://landed.jobs)**
